...
struct MapViewLinkingObjects: UIViewRepresentable {
	var shops: LinkingObjects<Shop>
	...
	class Coordinator: NSObject, MKMapViewDelegate {
		var parent: MapViewLinkingObjects

		init(_ parent: MapViewLinkingObjects) {
			self.parent = parent
		}
...
struct MapViewLinkingObjects_Previews: PreviewProvider {
